...
func newAction(db *gorm.DB, opts ...gen.DOOption) action {
	...
	_action.ActionID = field.NewInt64(tableName, "actionId")
	_action.ActionName = field.NewString(tableName, "actionName")
...
func (a *action) updateTableName(table string) *action {
	...
	a.ActionID = field.NewInt64(table, "actionId")
	a.ActionName = field.NewString(table, "actionName")
...
func (a *action) fillFieldMap() {
	...
	a.fieldMap["actionId"] = a.ActionID
	a.fieldMap["actionName"] = a.ActionName
}
