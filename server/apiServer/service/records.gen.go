...
func newRecord(db *gorm.DB, opts ...gen.DOOption) record {
	...
	_record.Time = field.NewInt64(tableName, "time")
...
func (r *record) updateTableName(table string) *record {
	...
	r.Time = field.NewInt64(table, "time")
...
func (r *record) fillFieldMap() {
	...
	r.fieldMap["recordId"] = r.RecordID
	r.fieldMap["carId"] = r.CarID
	r.fieldMap["streamId"] = r.StreamID
	r.fieldMap["actionId"] = r.ActionID
