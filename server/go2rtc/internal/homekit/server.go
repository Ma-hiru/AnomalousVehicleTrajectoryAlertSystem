...
import (
	...
	srtp2 "server/go2rtc/internal/srtp"
	"server/go2rtc/internal/streams"
	"server/go2rtc/pkg/core"
	"server/go2rtc/pkg/hap"
	"server/go2rtc/pkg/hap/camera"
	"server/go2rtc/pkg/hap/tlv8"
	"server/go2rtc/pkg/homekit"
	"server/go2rtc/pkg/magic"
	"server/go2rtc/pkg/mdns"
	"server/go2rtc/pkg/srtp"
)
