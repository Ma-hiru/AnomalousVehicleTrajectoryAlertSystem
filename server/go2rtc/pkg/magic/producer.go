...
import (
	...
	"server/go2rtc/pkg/flv"
	"server/go2rtc/pkg/h264/annexb"
	"server/go2rtc/pkg/magic/bitstream"
	"server/go2rtc/pkg/magic/mjpeg"
	"server/go2rtc/pkg/mpegts"
	"server/go2rtc/pkg/mpjpeg"
	"server/go2rtc/pkg/wav"
	"server/go2rtc/pkg/y4m"
)
...
func Open(r io.Reader) (core.Producer, error) {
	...
	// https://server/go2rtc/issues/747
