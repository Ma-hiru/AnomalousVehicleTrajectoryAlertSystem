...
import (
	...
	"server/go2rtc/pkg/hap/chacha20poly1305"
	"server/go2rtc/pkg/hap/curve25519"
	"server/go2rtc/pkg/hap/ed25519"
	"server/go2rtc/pkg/hap/hkdf"
	"server/go2rtc/pkg/hap/secure"
	"server/go2rtc/pkg/hap/tlv8"
	"server/go2rtc/pkg/mdns"
)
